...
class AiFeatureItem extends StatelessWidget {
  ...
  const AiFeatureItem({super.key,required this.aiFeature,
  ...
  Widget build(BuildContext context) {
    log('$runtimeType, build: ${((aiFeature.data?.length ?? 0) / 3).ceil()}, ${aiFeature.data?.length}');
    final heightCeil = ((aiFeature.data?.length ?? 0) / 3).ceil();
    return  Container(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                [
                  Checkbox(value: (aiFeature.isSelected), onChanged: (value) {
          ...
          if(aiFeature.data?.isNotEmpty == true)...[
            Container(
                 ...
                 const  SliverGridDelegateWithFixedCrossAxisCount(
                   ...
                   itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          Expanded(child: Text('${dataItem.value}'), ),
                          ...
                          child: TextButton(
                            ...
                            child: const Icon(Ionicons.trash_outline,size: 16,
                            color: Colors.red,),
                          ),)
                        ],
                      ),
              ...
              itemCount: aiFeature.data?.length ?? 0,),
            )
          ]
        ],
      ),
